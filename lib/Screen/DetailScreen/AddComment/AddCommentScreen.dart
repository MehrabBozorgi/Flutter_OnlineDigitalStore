...
import 'package:flutter_online_movie_shop/Screen/MovieScreen.dart';
import 'package:flutter_online_movie_shop/Widgets/AppUrlWidget.dart';
import 'package:flutter_online_movie_shop/Widgets/ShopButton.dart';
...
class _AddCommentScreenState extends State<AddCommentScreen> {
  ...
  sendInfo() async{
    var url = Uri.parse(
        AppUrl.url+'add_comment&comment_id='
        '${widget.idM.toString()}');
