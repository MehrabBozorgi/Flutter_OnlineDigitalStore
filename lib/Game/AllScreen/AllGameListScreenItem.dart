...
class AllScreenGameItem extends StatelessWidget {

  final List<dynamic> list;
  final int index;
  const AllScreenGameItem({ @required this.list,this.index,});
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                            Text('حجم بازی : ', style: kHomeTitle1),
                            Text(
                              list[index].hajm.toString(),
                              style: kUnSelectedTextTabView,
                            ),
